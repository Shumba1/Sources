...
| Brand posture, palette architecture, marketing/member shell expression, and Repair/Guides/Knowledge visual hierarchy | `docs/BRAND_AND_VISUAL_SYSTEM.md` | Added / active | Binding brand and visual system control file |
