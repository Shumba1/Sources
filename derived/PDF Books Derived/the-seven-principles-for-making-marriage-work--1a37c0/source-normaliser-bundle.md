# Source Normaliser Bundle — the-seven-principles-for-making-marriage-work--1a37c0

## Source registration summary
- source_id: src-the-seven-principles-for-making-marriage-work--1a37c0
- source_title: The Seven Principles for Making Marriage Work
- recommendation: selective-use
- canonical override: docs/MASTER_SPEC.md and docs/DRIFT_REGISTER.md override source conflicts.

## Theme clusters
1. resentment: symptom-to-pattern logic for repair-first triage.
...
- extract_id: the-seven-principles-for-making-marriage-work--1a37c0-ex01
  theme: resentment
  role: pattern
  claim: Early micro-signals of resentment are easier to interrupt than entrenched cycles.
  keep_ignore_caution: caution
- extract_id: the-seven-principles-for-making-marriage-work--1a37c0-ex02
  theme: resentment
  role: mechanism
  claim: Escalation often follows a repeating sequence: trigger, misread, defensive response, withdrawal.
  keep_ignore_caution: caution
- extract_id: the-seven-principles-for-making-marriage-work--1a37c0-ex03
  theme: resentment
  role: script
  claim: A short de-escalation script reduces ambiguity and creates a practical first step toward repair.
  keep_ignore_caution: caution
- extract_id: the-seven-principles-for-making-marriage-work--1a37c0-ex04
  theme: resentment
  role: warning
...
- extract_id: the-seven-principles-for-making-marriage-work--1a37c0-ex05
  theme: resentment
  role: intervention
