...
export const fixtureByState: Record<StateFixtureKey, StateFixture> = {
  steady: {
    ...
    statePageNextMove: 'Start the low-friction reset.',
  ...
  heatedButReachable: {
    ...
    statePageNextMove: 'Start the first repair step now.',
  ...
  activatedAndFragile: {
    ...
    statePageNextMove: 'Run the damage-stop entry point first.',
