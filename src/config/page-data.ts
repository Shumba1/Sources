...
export const pageData: Record<RouteId, PageConfig> = {
  ...
  guides: {
    ...
    hero: {
      ...
      title: 'Read the pattern without taking sides.',
      subtitle: 'Use Perspectives when you need a cleaner frame before choosing one constructive move.',
      primaryCta: cta('Start with both perspectives', '/guides?view=both#perspective-paths'),
  ...
  knowledge: {
    ...
    hero: {
      ...
      title: 'Understand the loop before you add another move.',
      subtitle: 'Use Knowledge when you need context, not a wall of theory.',
      primaryCta: cta('Start with drift', '/knowledge?topic=drift#knowledge-topics'),
