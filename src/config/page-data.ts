...
export const pageData: Record<RouteId, PageConfig> = {
  ...
  today: {
    ...
    displayTitle: 'Today',
    shell: 'app',
    intent: 'Daily operating dashboard with one clear next step.',
    canonical: true,
    hero: { title: 'Today’s next best move' },
    sections: [
      { key: 'today-hero', component: 'HeroBlock', variant: 'compact' },
      { key: 'today-current-state', component: 'StateSummaryCard' },
      { key: 'today-next-best-move', component: 'NextBestMoveCard' },
      {
      ...
      { key: 'today-make-it-worse', component: 'MakeItWorseCard' },
      { key: 'today-quick-scripts', component: 'QuickScriptRow' },
      { key: 'today-recheck', component: 'RecheckCard' },
    ],
  ...
  repair: {
    ...
    displayTitle: 'Repair',
    shell: 'app',
    intent: 'Symptom-led entry into protocols.',
    canonical: true,
    hero: { title: 'What needs repair right now?' },
    sections: [
      { key: 'repair-hero', component: 'HeroBlock', variant: 'compact' },
      { key: 'repair-search', component: 'SearchField', props: { placeholder: 'Search symptoms or situations' } },
      {
        key: 'repair-filters',
        component: 'FilterChipRow',
        props: { chips: ['Drift', 'Resentment', 'Attraction & Desire', 'Life Pressure', 'External Pressure', 'Stay & Rebuild'] },
      },
      { key: 'suggested-for-state', component: 'SuggestedModulesRail', title: 'Suggested for your current state' },
      {
      ...
      { key: 'repair-tools', component: 'ProductGrid', title: 'Resets and tools' },
    ],
